...
def filter_by_radius_origin(
    ...
    assert mode in ["keep_inner", "keep_outer"], "Mode must be 'keep_inner' or 'keep_outer'!"
...
def get_T_plane_reference(
    ...
    Returns:
        T_plane_reference (torch.Tensor) : Homogeneous transformation matrix
            ...
            Shape (4,4).
    """
    assert plane_parameters.shape == (4,), "Plane parameters must be a 1D tensor of length 4!"
